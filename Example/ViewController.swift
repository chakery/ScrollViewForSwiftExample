...
class ViewController: UIViewController,CGYScrollViewDelegate,UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let imageArray = [
            "http://h.hiphotos.baidu.com/image/pic/item/aa64034f78f0f73610034de60e55b319eac41353.jpg",
        ...
        let myView: CGYScrollView = CGYScrollView(frame: self.view.bounds, imageArray: imageArray, time: 3)
